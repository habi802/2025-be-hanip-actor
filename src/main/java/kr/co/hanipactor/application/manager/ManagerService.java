    ...
    public PageResponse<UserListRes> getUserList(UserListReq req) {
        ...
        List<UserListRes> result = page.stream().map(user -> {
                ...
                return UserListRes.builder()
                                  ...
                                  .address(mainAddress != null ? mainAddress.getPostcode() + ", " + mainAddress.getAddress() + (mainAddress.getAddressDetail() != null && !mainAddress.getAddressDetail().isEmpty() ? ", " + mainAddress.getAddressDetail() : "") : null)
                                  .phone(user.getPhone())
                                  .email(user.getEmail())
